...
describe "Project pages" do
  ...
  describe "project viewing" do
    ...
    let(:post ) { FactoryGirl.create(:post, user: user, postable: FactoryGirl.create(:ppost, title: "Foo", summary: "football"))  }
    before { visit user_ppost_path(user, post.postable) }    
  ...
  describe "shows likers and liker count" do
    ...
    let(:liked_post) { FactoryGirl.create(:post, user: other_user, postable: 
            (FactoryGirl.create(:ppost, title: "Foo", summary: "football"))) }
              
    before do
      user.like!(liked_post)
      visit user_ppost_path(other_user, liked_post.postable)
    end
  ...
  describe "project destruction" do
    ...
    describe "as correct user" do
      ...
      it "should delete a project" do        
        expect { click_link "delete" }.to change(Ppost, :count).by(-1)
      end
    end
  end
